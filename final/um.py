...
# fundo do jogo
background = pygame.image.load("new/images/espaco.png")
back_pos = 0
back_vel = 1000

# jogador
player = pygame.image.load("new/images/nave.png")
...
# inimigos
enemies = []
enemy = pygame.image.load("new/images/enemy.png")
...
# contador de vidas
life = pygame.image.load("new/images/coracao.png")
life_count = 3
...
count = 0
minutes = 0
counter_font = pygame.font.Font("new/images/Minecraft.ttf", 30)

# projéteis
p = []
pickle = pygame.image.load("new/images/pickle.png")
pickle_dt = 0.5
last_pickle = 0
...
# projétieis inimigos
pe = []
pew = pygame.image.load("new/images/pew.png")
pew_dt = 1.5
last_pew = 0
...
# pontuação
score = 0
score_font = pygame.font.Font("new/images/Minecraft.ttf", 30)

# game over
end_font = pygame.font.Font("new/images/Minecraft.ttf", 120)
